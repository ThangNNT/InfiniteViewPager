...
class Indicator : View{
    ...
    fun setViewPager(viewPager: ViewPager){
        ...
        this.viewPager?.addOnAdapterChangeListener { _, _, newAdapter ->
            newAdapter?.let {
                if(it is InfinitePagerAdapter){
                    this.pageCount = it.getRealCount()
                    selectedPosition = 0
    ...
    private fun setRectArrayWhenPositionOffsetChange(position: Int, positionOffset: Float){
        ...
        //Log.d("AAAAA", "position: $realPosition")
        //Log.d("AAAAA", "nextPosition: $nextPosition")
//        Log.d("AAAAA", "nextPositionWidthIncreasePercent: $nextPositionWidthIncreasePercent")
